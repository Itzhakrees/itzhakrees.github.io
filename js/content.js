  ...
  projects: [
    {
      ...
      en: {
        ariaLabel:
          "Combat Loop Prototype: core combat rhythm prototype focused on risk-reward tuning and readable feedback. Opens the main page.",
      ...
      zh: {
        ariaLabel: "战斗循环原型：围绕核心战斗节奏、风险回报调校和清晰反馈建立的原型。打开首页。",
        role: "玩法 / 系统设计",
        title: "战斗循环原型",
    ...
    },
    {
      ...
      en: {
        ariaLabel:
          "Traversal Level Case Study: greybox study for route readability, pacing contrast, and encounter staging. Opens the main page.",
        role: "Level design",
        title: "Traversal Level Case Study",
        summary: "Greybox study for route readability, pacing contrast, and encounter staging.",
      },
      zh: {
        ariaLabel: "移动探索关卡案例：关注路线可读性、节奏对比和遭遇编排的灰盒研究。打开首页。",
        role: "关卡设计",
        title: "移动探索关卡案例",
    ...
    },
    {
      ...
      en: {
        ariaLabel:
          "Constraint-Based Puzzle Prototype: fast prototype showing theme interpretation, compact teaching, and difficulty ramp. Opens the main page.",
      ...
      zh: {
        ariaLabel: "约束型解谜原型：展示快速构思、主题转译、紧凑教学和难度曲线的原型。打开首页。",
        role: "Game Jam / 实验设计",
        title: "约束型解谜原型",
