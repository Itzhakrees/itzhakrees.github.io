window.portfolioContent = {
  ui: {
    ...
    zh: {
      ...
      introCopy:
        "我关注清晰可读的系统、有表达力的机制，以及让玩家选择从第一分钟起就显得有意图的关卡体验。",
      ...
      projectsTitle: "项目",
      projectsIntro:
        "为设计负责人准备的紧凑案例：项目是什么、我负责什么，以及完整拆解的位置。",
      researchEyebrow: "研究",
      researchTitle: "论文研究",
      researchIntro:
  ...
  projects: [
    {
      ...
      markdownBase: "content/projects/combat-loop",
      en: {
        ariaLabel:
          "Combat Loop Prototype: core combat rhythm prototype focused on risk-reward tuning and readable feedback. Opens the project case study.",
      ...
      zh: {
        ariaLabel: "战斗循环原型：围绕核心战斗节奏、风险回报调校和清晰反馈建立的项目案例。",
        role: "玩法 / 系统设计",
        title: "战斗循环原型",
    ...
    },
    {
      ...
      markdownBase: "content/projects/traversal-level",
      en: {
        ariaLabel:
          "Traversal Level Case Study: greybox study for route readability, pacing contrast, and encounter staging. Opens the project case study.",
        role: "Level design",
    ...
    },
    {
      ...
      markdownBase: "content/projects/constraint-puzzle",
      en: {
        ariaLabel:
          "Constraint-Based Puzzle Prototype: fast prototype showing theme interpretation, compact teaching, and difficulty ramp. Opens the project case study.",
